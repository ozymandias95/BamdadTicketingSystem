...
public class TicketEntityConfigs : IEntityTypeConfiguration<Ticket>
{
    public void Configure(EntityTypeBuilder<Ticket> builder)
    {
        ...
        builder.Property(t => t.SubmitAt).HasColumnType("datetime").HasDefaultValueSql("getDate()");
        builder.HasOne(t => t.SubmitBy).WithMany(u => u.Tickets).HasForeignKey(t => t.UserId);
